...
export const ONBOARDING_QUESTIONS = [
  // SECTION 0 - Getting Started (NEW)
  {
    ...
    subtext: 'Just so the persona knows who they\'re speaking with.',
    example: null,
  ...
  },
  {
    ...
    subtext: 'Feel free to include any middle names or special nicknames.',
  ...
  // SECTION 1 - Relationship Context
  {
    ...
    subtext: 'Tell us a bit about the bond you shared.',
  ...
  },
  {
    ...
    subtext: 'A general year or a specific date is fine—whatever feels right.',
  ...
  },
  {
    ...
    subtext: 'This is optional, but it can help the persona understand the weight of your journey.',
  ...
  // SECTION 2 - Core Personality
  {
    ...
    subtext: 'Were they the life of the party, or more of a quiet observer?',
  ...
  },
  {
    ...
    subtext: 'When they were truly happy or "in the zone," what did that look like?',
  ...
  },
  {
    ...
    subtext: 'Did they have a funny way of clearing their throat, or a specific phrase they\'d say when annoyed?',
  ...
  },
  {
    ...
    subtext: 'Was it a quiet giggle, a loud belly laugh, or a mischievous smirk?',
  ...
  },
  {
    ...
    subtext: 'Like how they made their coffee just right, or a specific spot they sat in every evening.',
  ...
  // SECTION 3 - Communication Style
  {
    ...
    subtext: 'Was it all jokes and teasing, or were they more serious and thoughtful?',
  ...
  },
  {
    ...
    subtext: 'Would they give you a big pep talk, or just sit quietly and say, "It\'s gonna be okay"?',
  ...
  },
  {
    ...
    subtext: 'Think of those "classic" things they always said—even the ones that made you roll your eyes.',
  ...
  },
  {
    ...
    subtext: 'Did they send random articles, fix things, or just bring you your favorite snack?',
  ...
  // SECTION 4 - Values & Beliefs
  {
    ...
    subtext: 'Was it family, their work, or maybe just a simple dream they always had?',
  ...
  },
  {
    ...
    subtext: 'Were they "everything happens for a reason" people, or "roll up your sleeves" types?',
  ...
  },
  {
    ...
    subtext: 'If they could leave you with one piece of life advice, what would it be?',
  ...
  },
  {
    ...
    subtext: 'We all have them! Did they hate slow drivers, or were they just stubbornly honest?',
  ...
  // SECTION 5 - Shared Memories
  {
    ...
    subtext: 'Close your eyes and think of one day you\'d relive—what was the "vibe" of that moment?',
  ...
  },
  {
    ...
    subtext: 'Was it Sunday dinners, long car rides, or just texting funny memes?',
  ...
  },
  {
    ...
    subtext: 'What\'s the first thing they\'d do? Would they give you a hug, or crack a joke?',
  ...
  // SECTION 6 - Boundaries & Safety
  {
    ...
    subtext: 'Are there topics that feel too heavy, or an inside joke that wouldn\'t feel right coming from an AI?',
  ...
  },
  {
    ...
    subtext: 'If they never used certain slang or never talked about politics, let us know.',
  ...
  // SECTION 7 - Present-Day Awareness
  {
    ...
    subtext: 'Should they talk like they\'re still here, or acknowledge they\'re speaking from your memories?',
    example: null,
    inputType: 'select',
  ...
  },
  {
    ...
    subtext: 'Would they find it amazing that they\'re an AI, or just want to focus on catching up?',
  ...
  // SECTION 8 - Final Tuning
  {
    ...
    subtext: 'Is there one more story or a specific "secret" trait that only you know? This is your chance for that extra spark.',
